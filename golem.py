...
TOKEN = '7837130437:AAHnHtp_pRmWXGTll-UKI-3BT1_SQaKS76E'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002275893076          #telegram mai group bana ke chat id dalo      
CHANNEL_ID = -1002275893076                      #telegram mai group bana ke chat id dalo      
error_channel_id = -1002275893076                   #telegram mai group bana ke chat id dalo      
...
def handle_attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "*💣JALDI ATTACK MAAR BAHI KISI NE BHI NI LAGA RAKHA *\n"  # Ready to launch message
                                   ...
                                   "*OWNER @DEVILVIPDDOS🧛*", parse_mode='Markdown')  # Start chaos message
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀PING DEKH NICHE 677 HOGYA !👻*\n\n"  # Attack launched message
                                           f"*TIME ==> {duration} seconds send feedback to @DEVILVIPDDOS🔥*", parse_mode='Markdown')  # Duration message
